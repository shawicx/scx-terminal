...
<template>
    <SelectRoot v-model="model">
        ...
        <SelectPortal>
            <SelectContent
                position="popper"
                class="relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95"
            >
