...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            config::local_group_create,
            config::local_group_update,
            config::local_group_delete,
            config::ssh_group_create,
            config::ssh_group_update,
            config::ssh_group_delete,
            config::tab_group_create,
            config::tab_group_update,
            config::tab_group_delete,
            config::tab_session_get,
